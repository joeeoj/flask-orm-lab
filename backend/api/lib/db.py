...
from settings import DB_USER, DATABASE, TEST_DATABASE, TEST_DB_USER


test_conn = psycopg2.connect(dbname=TEST_DATABASE, user=TEST_DB_USER)
...
def drop_all_tables(conn, cursor):
    table_names = ["actors", "directors", "movie_actors", "movie_directors", "movies"]
