...
from api.lib.db import get_db, close_db, drop_all_tables, save, test_conn, test_cursor
from api.models import Movie, Actor, MovieActor
from settings import TEST_DATABASE, TEST_DB_USER, TEST_DB_PASSWORD
from tests.models.test_actor import actor


@pytest.fixture(scope="module")
def app():
    flask_app = create_app(TEST_DATABASE, TEST_DB_USER, TEST_DB_PASSWORD)
